...
public interface DailyFootAnalysisRepository extends JpaRepository<DailyFootAnalysis, Long> {
    ...
    Optional<DailyFootAnalysis> findTopByMeasurementSessionIdOrderByUpdatedAtDescIdDesc(Long measurementSessionId);

    default Optional<DailyFootAnalysis> findByMeasurementSessionId(Long measurementSessionId) {
