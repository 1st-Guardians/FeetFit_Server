    ...
    */
    ...
    public static ReportResponseDTO.DailyFootAnalysisResultDTO toDailyFootAnalysisResultDTO(
        ...
        return ReportResponseDTO.DailyFootAnalysisResultDTO.builder()
                ...
                .beforeTemperatureCelsius(analysis.getBeforeTemperatureCelsius())
                .beforeHumidityPercent(analysis.getBeforeHumidityPercent())
                .afterTemperatureCelsius(analysis.getAfterTemperatureCelsius())
                .afterHumidityPercent(analysis.getAfterHumidityPercent())
