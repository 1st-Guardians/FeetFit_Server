...
public class ReportController {
    ...
    @Operation(
            ...
            description = """
                ...
                - 본인의 측정 세션 ID만 사용 가능합니다.
                - 오늘을 제외한 최근 동일 지표 분석 결과를 최대 10개 조회하여 오늘 결과와 비교합니다.
                - 이전 결과가 없으면 오늘 결과만으로 status와 advice를 생성합니다.
                - status와 advice는 GPT가 생성하며, GPT 호출 실패 시 기존 점수 기준 status와 요청 advice를 사용합니다.
                - 요청 advice는 정확히 2개여야 하며 GPT 입력의 오늘 원본 분석 설명 및 장애 시 대체값으로 사용됩니다.
